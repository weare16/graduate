	...
	<section class="layui-larry-box">
		<div class="larry-personal">
			<div class="larry-personal-body clearfix">
				<form    class="layui-form col-lg-6 " action="${path}/system/dicmanage/Add.htm" method="post">
          ...
          form.on('submit(adddic)', function(data){
           ...
           //使用ajax提交
            $.ajax({
		       ...
		       data: data.field,
		       dataType:"json",
		       url: "${path}/system/dicmanage/Add.htm?BUSINIDarr="+BUSINIDarr+"&BUSINNAMEarr="+BUSINNAMEarr+"&statusArr="+statusArr+"",
