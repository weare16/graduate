...
<body>
	<section class="layui-larry-box">
		<div class="larry-personal">
			<div class="larry-personal-body clearfix">
				<form id="editorgform"      class="layui-form col-lg-8 " action="${path}/system/orgmanage/Edit.htm" method="post">
					<div class="layui-form-item">
						<label class="layui-form-label">机构名称</label>
						<div class="layui-input-block">
							<input type="text" name="orgname" required lay-verify="required"
								class="layui-input " value="${org.orgname }">
								<input type="hidden" name="orgid" required lay-verify="required"
								class="layui-input " value="${org.orgid }" disabled>
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="orgaddress"  
								class="layui-input " value="${org.orgaddress }">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">上级机构</label>
						<div class="layui-input-block">
						    <input type="hidden" id="userparentorg_id"  value="${org.parentorg}" > 
							<select id="select_editorg"  name="parentorg" lay-verify="required"  required  lay-search>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							 <textarea  name="remark"   class="layui-textarea" placeholder="请输入内容">${org.remark }</textarea>
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">可用状态</label>
						<div class="layui-input-block">
						     <input type="hidden" id="orgstate_id"  value="${org.state}" /> 
							<input name="state" type="checkbox"  lay-skin="switch"  lay-text="ON|OFF" value="0">
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-input-block">
							<button class="layui-btn" lay-submit lay-filter="editorg">立即提交</button>
	...
	;!function(){
         ...
         ,form = layui.form;
		  //下拉框自动选中
          var orgid=$("#userparentorg_id").val();
          $("#select_editorg").find("option[value = "+orgid+"]").attr("selected","selected");
          //switch开关选中
          var state=$("#orgstate_id").val();
          if(state=='0'){
	     ...
	     //提交监听提交
          form.on('submit(editorg)', function(data){
           ...
           $.ajax({
		       ...
		       data: data.field,
		       dataType:"json",
		       url: "${path}/system/orgmanage/Edit.htm",
