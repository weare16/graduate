	...
	<section class="layui-larry-box">
		<div class="larry-personal">
			<div class="larry-personal-body clearfix">
				<form    class="layui-form col-lg-6 " action="${path}/system/rolemanage/Add.htm" method="post">
					<div class="layui-form-item">
					 ...
					 <div class="layui-form-item">
						...
						<div class="layui-input-block">
							<textarea class="layui-textarea" name="usergpdesc" placeholder="请输入内容" required lay-verify="required"></textarea>
					 ...
					 <div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="checkbox" name="isactive" lay-skin="switch" lay-text="ON|OFF"  value="0" checked>
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-input-block">
	     ...
	     //提交监听提交
          form.on('submit(addgroup)', function(data){
           ...
           $.ajax({
		       ...
		       data: data.field,
		       dataType:"json",
		       url: "${path}/system/rolemanage/Add.htm",
