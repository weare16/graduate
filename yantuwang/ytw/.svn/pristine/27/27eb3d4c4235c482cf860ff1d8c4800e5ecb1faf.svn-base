	...
	<section class="layui-larry-box">
		<div class="larry-personal">
			<div class="larry-personal-body clearfix">
				<form  class="layui-form col-lg-8 " action="${path}/system/menumanage/Add.htm" method="post">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<select name="pmenuid" lay-verify="required"  lay-search>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<select name="menulv"   lay-verify="required"   >
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input name="isactive" type="checkbox" checked="" lay-skin="switch"  lay-text="ON|OFF" value="0">
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-input-block">
        ...
        //提交监听提交
          form.on('submit(addmenu)', function(data){
           ...
           $.ajax({
		       ...
		       data: data.field,
		       dataType:"json",
		       url: "${path}/system/menumanage/Add.htm",
